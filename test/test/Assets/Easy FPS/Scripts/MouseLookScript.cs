...
public class MouseLookScript : MonoBehaviour {
	...
	private PlayerMovementScript playermove;
	public GameObject Target;
    
    public bool dodgeEnd = true;
	public float dodgeCameraMovesize = 0.8f;
    /*
	 * Hiding the cursor.
	 */
    void Awake(){
	...
	*/
    ...
    IEnumerator WaitDodge()
    {
        ...
        dodgeEnd = true;
        myCamera.position = new Vector3(Target.transform.position.x, Target.transform.position.y , Target.transform.position.z);
    }




    void CameraMoveinDodge() {
        playermove = GetComponent<PlayerMovementScript>();
		
		if (playermove.isDodge == true)
		{
			dodgeEnd = false;
		...
		if (dodgeEnd == false)
		{
			myCamera.position = new Vector3(Target.transform.position.x, Target.transform.position.y - dodgeCameraMovesize, Target.transform.position.z);
